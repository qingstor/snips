...
| Structure Name | Element|Element Type | 
|--------------------|----------|--------------------|
|Property | ID | `String` |
| |Name|`String`|
| |Description|`String`|
...
|StatusCode|Code|`Integer`|
| |Description|`String`|
|Response|StatusCodes|`StatusCode Pointer`|
| |Headers|`Property Pointer`|
| |Elements|`Property Pointer`|
| |Body|`Property Pointer`|
|Request|Method|`String`|
| |URI|`String`|
| |Params|`Property Pointer`|
| |Headers|`Property Pointer`|
| |Elements|`Property Pointer`|
| |Body|`Property Pointer`|
|Operation|ID|`String`|
...
| |Name|`String`|
| |Properties|`Property Pointer`|
| |Operations|`Operation Map`|
|Service |APIVersion|`String`|
| |Name|`String`|
| |Description|`String`|
| |Properties|`Property Pointer`|
| |Operations|`Operation Pointer Map`|
|Data|Service|`Service Pointer`|
| |SubServices|`SubService Map`|
| |CustomizedTypes|`Property Map`|
